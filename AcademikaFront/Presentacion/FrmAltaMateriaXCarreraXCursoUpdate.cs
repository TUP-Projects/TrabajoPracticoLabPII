...
{
    public partial class FrmAltaMateriaXCarreraXCursoUpdate : Form
    {
        ...
        public FrmAltaMateriaXCarreraXCursoUpdate()
        {
            InitializeComponent();
        ...
        public FrmAltaMateriaXCarreraXCursoUpdate(MateriasXCarrera matxcar, Curso cur, string jefe, string prof, string ayud) {
            InitializeComponent();
            servicio = new ServiceFactoryImp().CrearServiceMaterias();
            this.mxcAnt = matxcar;
            this.cursoAnt = cur;
